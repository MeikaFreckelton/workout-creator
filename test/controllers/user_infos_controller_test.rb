...
class UserInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post user_infos_url, params: { user_info: { date_of_birth: @user_info.date_of_birth, gender: @user_info.gender, height: @user_info.height, name: @user_info.name, user_id: @user_info.user_id, weight: @user_info.weight } }
    end
  ...
  test "should update user_info" do
    patch user_info_url(@user_info), params: { user_info: { date_of_birth: @user_info.date_of_birth, gender: @user_info.gender, height: @user_info.height, name: @user_info.name, user_id: @user_info.user_id, weight: @user_info.weight } }
